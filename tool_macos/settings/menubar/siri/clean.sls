...
{#-
    Resets display status of Siri widget in Menu Bar to default (hidden).
#}
...
Display status of Siri widget in Menu Bar is reset to default (hidden) for user {{ user.name }}:
