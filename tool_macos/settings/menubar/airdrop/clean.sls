...
{#-
    Resets display status of Airdorp widget in Menu Bar to default (hidden).
#}
...
Display status of Airdrop widget in Menu Bar is reset to default (hidden) for user {{ user.name }}:
